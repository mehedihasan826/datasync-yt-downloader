...
<div align="right">
  ...
  <a href="README.ja.md"><img src="https://img.shields.io/badge/Language-日本語-red?style=for-the-badge" alt="日本語"></a>
</div>
...
3. Google Driveのパスが自动検出され、マスターの役割に構成された`.env`ファイルが作成されます。
4. **`.env`の確認**: `.env`ファイルを開き、パスが正しいことを確認します。
5. アプリケーションの実行：
   ```bash
